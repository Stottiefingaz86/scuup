...
export function LandingFooter() {
  ...
  return (
    <footer className="px-4 pb-6 pt-4 sm:px-6">
      <div className="landing-footer-panel relative mx-auto w-full max-w-7xl overflow-hidden rounded-3xl border border-border/80">
        <div
          aria-hidden
        ...
        <button
          ...
          className={cn(
            "group relative block w-full min-w-0 border-t border-border/50 text-left",
        ...
        >
          ...
          <span className="relative mt-2 block text-xs text-muted-foreground">
            About us
          </span>
        </button>
      </div>
